...
public final class AgentEffectApi {
    ...
    public Holder<MobEffect> resolve(String id) throws AgentApiException {
        ...
        return BuiltInRegistries.MOB_EFFECT.getHolder(resource).orElseThrow(() ->
                new AgentApiException("INVALID_ARGS", "Unknown effect: " + id));
    }
    ...
    public boolean apply(LivingEntity entity, String effectId, int seconds, int amplifier,
        ...
        int ticks = effect.value().isInstantenous() ? 1 : seconds * 20;
